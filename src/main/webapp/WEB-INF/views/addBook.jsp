...
<div class="container">
  <form:form action="processAddBook" modelAttribute="book" method="POST">
    ...
    <form:input type="text" id="bookName" path="bookName" placeholder="Book's name.."/>

    <form:label for="authorName" path="authorName">Author Name</form:label>
    <form:input type="text" id="authorName" path="authorName" placeholder="Book's Author name.."/>
    
       
    <form:label for="bookVersion" path="bookVersion">Book Version</form:label>
    <form:input type="text" id="bookVersion" path="bookVersion" placeholder="Books's Version."/>
    
    
    <form:label for="publicationDate" path="publicationDate">Publication Date</form:label>
    <form:input type="date" id="publicationDate" path="publicationDate" placeholder="Book's publication date.."/></br>
    
    <form:label for="quantity" path="bookInventory.quantity">Quantity of Book</form:label>
    <form:input type="text" id="Quantity" path="bookInventory.quantity" placeholder="Quantity of the book to add"/>
